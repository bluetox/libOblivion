...
pub mod mode {
    #[cfg(feature = "all")]
    pub use super::mode_2::*;
    #[cfg(feature = "all")]
    pub use super::mode_3::*;
    #[cfg(feature = "all")]
    pub use super::mode_5::*;

    #[cfg(all(feature = "mode2", not(feature = "all")))]
    pub use super::mode_2::*;

    #[cfg(all(not(any(feature = "mode2", feature = "mode5")), not(feature = "all")))]
    pub use super::mode_3::*;

    #[cfg(all(feature = "mode5", not(feature = "all")))]
    pub use super::mode_5::*;
}
